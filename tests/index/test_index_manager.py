...
def test_get_total_size():
    ...
    prefixes = [
        ...
        "data/raw/Gordon_Gunter/GU1402L1/EK60/",  # L1 and L2
...
def test_get_total_size_HB1402():
    prefixes = [
        "data/raw/Henry_B._Bigelow/HB1402/EK60/",
    ]
    index_manager = IndexManager("noaa-wcsd-pds")
...
def test_get_total_size_henry_bigelow():
    # files from here: https://docs.google.com/spreadsheets/d/1_mpVNaZI9hD3kG0P4cZIkG-TI6bCh9FTORPy3KfPq-o/edit?gid=0#gid=0
    prefixes = ["data/raw/Henry_B._Bigelow/"]
    index_manager = IndexManager("noaa-wcsd-pds")
    index_manager.get_total_size(prefixes=prefixes)


# Level 2 data
def test_get_total_size_henry_bigelow_l2():
    # files from here: https://docs.google.com/spreadsheets/d/1_mpVNaZI9hD3kG0P4cZIkG-TI6bCh9FTORPy3KfPq-o/edit?gid=0#gid=0
    prefixes = ["level_2/Henry_B._Bigelow/"]
...
def test_get_total_size_henry_bigelow_hb0707_l2():
    # files from here: https://docs.google.com/spreadsheets/d/1_mpVNaZI9hD3kG0P4cZIkG-TI6bCh9FTORPy3KfPq-o/edit?gid=0#gid=0
    prefixes = ["level_2/Henry_B._Bigelow/HB0707/EK60/HB0707.zarr/"]
    index_manager = IndexManager("noaa-wcsd-zarr-pds")
    index_manager.get_total_size(prefixes=prefixes)
...
def test_get_total_size_henry_bigelow_hb1906_l2():
    # files from here: https://docs.google.com/spreadsheets/d/1_mpVNaZI9hD3kG0P4cZIkG-TI6bCh9FTORPy3KfPq-o/edit?gid=0#gid=0
    prefixes = ["level_2/Henry_B._Bigelow/HB1906/EK60/HB1906.zarr/"]
    index_manager = IndexManager("noaa-wcsd-zarr-pds")
    index_manager.get_total_size(prefixes=prefixes)


def test_get_total_size_henry_bigelow_hb0707_l0():
    prefixes = ["data/raw/Henry_B._Bigelow/HB0707/EK60/"]
    index_manager = IndexManager("noaa-wcsd-pds")
    index_manager.get_total_size(prefixes=prefixes)
...
def test_index_s3_bucket():
    ...
    index_manager.index_s3_bucket(
        prefix="data/raw/", file_name="noaa-wcsd-pds-index.csv"
    )
...
def test_index_s3_bucket_small_sha():
    ...
    index_manager = IndexManager("noaa-wcsd-pds")
    index_manager.index_s3_bucket(
        prefix="data/raw/Henry_B._Bigelow/HB0706/metadata/",
        file_name="noaa-wcsd-pds-index-test.csv",
    )
